 ...
 */
class GenerateDatabaseAllController extends AbstractCliPommController implements ConsoleUsageProviderInterface
{
    private $filename;
    private $namespace;
    ...
    public function getConsoleUsage(Console $console)
    {
        return array(
            ...
            'generate-database-all' => 'Generate structure, model and entity file for all relations of all schemas in a database.',
